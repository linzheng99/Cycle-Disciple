      ...
      <ScrollArea.Root className={cn('overflow-hidden', className)}>
        <ScrollArea.Viewport className='flex h-full flex-col'>
          ...
          <ScrollArea.Scrollbar
            className="bg-#d9d9d9 hover:bg-#b2b2b2 duration-[160ms] flex touch-none select-none p-0.5 transition-colors ease-out data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
          ...
          <ScrollArea.Scrollbar
            className="duration-[160ms] flex touch-none select-none bg-black p-0.5 transition-colors ease-out hover:bg-black data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
